...
class SubjectListViewController: UITableViewController, BindableType {
    // MARK: properties
    ...
    func bindViewModel() {
        viewModel.subjects.bind(to: tableView.rx.items) { (_: UITableView, _: Int, element: Subject) in
            let cell = UITableViewCell(style: .default, reuseIdentifier: "userCell")
            cell.textLabel?.text = element.courseCode
